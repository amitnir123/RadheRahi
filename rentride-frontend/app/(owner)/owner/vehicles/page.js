            ...
            <div className="max-w-5xl mx-auto px-4 py-8">
                ...
                {vehicles.length === 0 ? (
                    <div className="text-center py-24">
                        ...
                        <p className="text-text-secondary mb-6">Start earning by listing your vehicle</p>
                        <Link href="/owner/vehicles/new" className="btn-primary">
                            ...
                            return (
                                <div key={v._id} className="card flex gap-4 items-center">
                                    ...
                                    <div className="flex items-center gap-2 flex-shrink-0">
                                        <Link
                                            href={`/owner/vehicles/${v._id}/edit`}
