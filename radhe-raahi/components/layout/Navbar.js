        ...
        <div className="hidden md:flex items-center gap-4">
          {!user ? (
            ...
            <div className="flex items-center gap-4">
              ...
              {userRole === "renter" && (
                <Link href="/renter" className="text-xs text-brand-cyan bg-brand-cyan/10 px-3 py-1.5 rounded-lg border border-brand-cyan/20 flex items-center gap-1">
                  <Car size={14} /> Renter Portal
                </Link>
              )}
              {userRole === "owner" && (
                <Link href="/owner" className="text-xs text-brand-gold bg-brand-gold/10 px-3 py-1.5 rounded-lg border border-brand-gold/20 flex items-center gap-1">
                  <Briefcase size={14} /> Owner Engine
                </Link>
              )}
              {userRole === "admin" && (
                <Link href="/admin" className="text-xs text-red-400 bg-red-400/10 px-3 py-1.5 rounded-lg border border-red-400/20 flex items-center gap-1">
